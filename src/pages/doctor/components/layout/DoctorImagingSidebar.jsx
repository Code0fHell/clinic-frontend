...
const menuItems = [
    { icon: LayoutGrid, path: "/diagnostic/dashboard", label: "Dashboard" },
    {
        icon: FileText,
        path: "/diagnostic/indications",
        label: "Danh sách chỉ định",
    },
    {
        icon: ClipboardCheck,
        path: "/diagnostic/completed-results",
        label: "Kết quả đã xử lý",
    },
];

export default function DoctorImagingSidebar() {
    return (
