...
export default function AppointmentOverview() {
    return (
        <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-5">Lịch hẹn tổng quan</h3>
            <div className="grid grid-cols-4 gap-8 text-center">
                <div>
                    <p className="text-5xl font-bold text-teal-700">46</p>
                ...
                <div>
                    <p className="text-5xl font-bold text-red-600">6</p>
